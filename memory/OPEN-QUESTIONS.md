...
| Q-006 | Retrieval v3 — exact final dev/holdout sizes, confidence/precision rule, user-centered paired latency budget and final pilot protocol remain unresolved; to be fixed after retrieval-blind pilot and before candidate tuning / one-way protected evaluation — 2026-09-01 open | 2026-09-01 | open |
