...
- **Two genuinely independent durable OMP child annotators (separate outside-repo clean directories, no shared state, blind to each other and to original labels, --no-extensions, no repo/add-dir):**
  ...
  - Durable OMP evidence fixture `omp_provenance_evidence.json` SHA256 `6029a64cc4c74dd0f8f137d1e20f9445779c2bfc79484269ee28ba2685528721` provides deterministic offline lineage (portable transcript paths/SHAs, model roles, cwd confinement, child vs committed SHAs) without home/live-session dependency.
