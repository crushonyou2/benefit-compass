...
- **Two genuinely independent durable OMP child annotators (separate outside-repo clean directories, no shared state, blind to each other and to original labels, --no-extensions, no repo/add-dir):**
  - Reviewer A: `reviewer_A_raw_labels.jsonl` SHA256 `ad7f8017f125209a7c43a3cb67b359d1585eb3eb1c63d36abdd694179ec37dc5` + `reviewer_A_provenance.json` (session `01a05a53-9832-7217-88d6-a80105c3c296`, transcript `e9416277b25cb3d91db19f82ca737e24436c0c277b56721ae6f0f70b27823aef` portable, model `openai-codex/gpt-5.6-luna:xhigh` xhigh, timestamp 2026-09-01T00:17:03.026Z, cwd `C:/tmp/benefit-compass-clean-A` outside-repo, sanitized+rubric only)
  - Reviewer B: `reviewer_B_raw_labels.jsonl` SHA256 `aaf349afe6e327bd23bd55d4ebb2970b431d62db5b6f07595fb942599267063f` + `reviewer_B_provenance.json` (session `01a05a54-8e7b-741e-b6df-ddbcf2c125e2`, transcript `de7f79517138eb78ec2f5f0cef6a43efecd22bc4db67c1423da2a0d1d668b1a1`, same Luna xhigh, timestamp 00:18:06.075Z, cwd `C:/tmp/benefit-compass-clean-B`, blind to A)
